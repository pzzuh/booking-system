...
-- Updated: April 2026 (fixed schema to match PHP booking forms)
...
-- =============================================================
-- FACILITY BOOKINGS
-- FIX: Added `notes` column used by book_facility_form.php
-- =============================================================
...
-- =============================================================
-- ITEM BOOKINGS
-- FIX: Columns renamed/added to match book_item_form.php:
--   quantity_requested -> quantity_needed
--   date_start (DATETIME) -> borrow_date (DATE) + borrow_time (TIME)
--   date_end   (DATETIME) -> return_date (DATE) + return_time (TIME)
--   Added `notes` column
-- =============================================================
