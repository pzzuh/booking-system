...
(function(){
    ...
    const facCal  = buildMiniCalendar('miniFacilityCalendar', 'get_facility_events.php?mine=1');
    const itemCal = buildMiniCalendar('miniItemCalendar',     'get_item_events.php?mine=1');
