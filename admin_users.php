...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($action === 'update_info') {
            ...
            if ($full_name === '') {
                redirectWithMessage('admin_users.php', 'danger', 'Name cannot be empty.');
            }
            ...
            <tr>
              ...
              <td>
                <form method="post" class="d-flex flex-column gap-1" style="min-width:180px;">
                  ...
                  <input class="form-control form-control-sm" name="full_name" value="<?= e((string)$u['full_name']) ?>" placeholder="Full name" required>
                  <input class="form-control form-control-sm" name="student_id" value="<?= e((string)($u['student_id'] ?? '')) ?>" placeholder="ID number">
