...
try {
    ...
    $stmt = $pdo->prepare(
        "SELECT ib.id, ib.quantity_needed, ib.borrow_date, ib.return_date, ib.borrow_time, ib.return_time, ib.status, ib.current_approval_role,
              ...
              <tr>
                ...
                <td class="text-end">
                  <div class="d-flex justify-content-end gap-2 flex-wrap">
                    ...
                    <button class="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#rejF<?= (int)$r['id'] ?>">Reject</button>
                  </div>
              ...
              <tr>
                ...
                <td class="text-end">
                  <div class="d-flex justify-content-end gap-2 flex-wrap">
                    ...
                    <button class="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#rejI<?= (int)$r['id'] ?>">Reject</button>
                  </div>
